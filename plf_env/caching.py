...
def cache(
    ...
    exclude: dict = None,
    should_cache=None,
    disk_caching_enabled: bool = settings.DISK_CACHING,
):
    ...
    def decorator(fn):
        ...
        def decorated(*args, **kwargs):
            ...
            # add to memory cache
            if ellapsed >= min_memory_time and (
                ellapsed < min_disk_time or not disk_caching_enabled
            ):
